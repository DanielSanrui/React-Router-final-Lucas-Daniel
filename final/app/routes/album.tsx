...
const Album = () => {
  ...
  return (
    <div>
      <h1 className="text-4xl font-bold mb-6 text-center">{album.title}</h1>
      <img src={album.cover_big} alt={`Cover of ${album.title}`} className="w-64 h-64 rounded-md mb-4 mx-auto" />
