...
const Artist = () => {
  ...
  return (
    <div>
      <h1 className="text-4xl font-bold mb-6 text-center">{artist.name}</h1>
      <img src={artist.picture_big} alt={`Cover of ${artist.name}`} className="w-64 h-64 rounded-md mb-4 mx-auto" />
